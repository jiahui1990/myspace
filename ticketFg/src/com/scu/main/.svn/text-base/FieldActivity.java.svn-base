...
public class FieldActivity extends Activity {
	...
	private void init() {
		//打开wifi,蓝牙
		//new PdaUtil().openWifi(this);
		//new PdaUtil().openBluetooth(this);
	     ...
	     gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, //The AdapterView where the click happened   
			    ...
			    if(projectName.equals(Consts.FIELD_PPC)){
			    	new MainUtil().playSound(FieldActivity.this, Consts.SOUND_SELECT_PPC);
			    }else if(projectName.equals(Consts.FIELD_DDC)){
			    	new MainUtil().playSound(FieldActivity.this, Consts.SOUND_SELECT_DDC);
			    }
			    
			    Intent intent = new Intent(FieldActivity.this,CardActivity.class);
		...
		public void handleMessage(android.os.Message msg) {
			...
			case Consts.LOAD_FIELD_FAIL:
			{
				try {
					...
					String url_get_fields = getResources().getString(R.string.BASE_URL)+"/fieldInfoAction_getAllFields";
					new MainUtil().getAllProjects(FieldActivity.this, url_get_fields);
				} catch (InterruptedException e) {
					e.printStackTrace();
				}
				ToastUtil.showShort(FieldActivity.this, "连接服务器失败");
			}break;
			...
			{
				ToastUtil.showShort(FieldActivity.this, "获取数据为空");
			}break;
			case Consts.GET_FIELDS_SUCCESS:
			{
			    ...
			    //实例化一个适配器
			    SimpleAdapter adapter = new SimpleAdapter(FieldActivity.this, items, R.layout.grid_item, 
