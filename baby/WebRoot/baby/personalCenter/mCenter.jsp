...
<html>
  <head>
	...
	<script type="text/javascript" src="/baby/personalCenter/js/mCenter.js"></script>
	<!--
  ...
  <%@include file="/pages/mHead.jsp" %>
    <div style="position: absolute;top: 100px;;left:270px; width: 422px;">
    	...
    	<table style="border-spacing:10px 20px; text-align: left;font-size: 18px;font-family: 'Arial Normal', 'Arial'; font-weight: 400; font-style: normal; color: #333333;">
    		<tr>
    			<td width="130px;"><span class="title">用户名</span></td>
    			<td><input value="${user.username }" type="text" name="In.users.username"></td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			<td width="130px;"><span class="title">手机</span></td>
    			<td><input id="telphone" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="11" value="${user.telphone }" type="text" name="In.users.telphone"></td>
    		</tr>
    		<tr>
