...
<html>
  <head>
	...
	<script type="text/javascript" src="/baby/monitorManage/js/addMonitor.js"></script>
  </head>
  ...
  <div class="div_main">
    ...
    <div style="position: absolute;top: 83px;left:0px;width: 900px;height: 450px;border-radius:5px;background: rgb(242,242,242);">
    	<div style="position: absolute; left: 5px; top: 20px; width: 344px; height: 414px; background-image: url('/images/manage/u381.png')">
    		...
    		<div id="btn_createmonitor" style="position: absolute;left: 240px;top: 18px;cursor: pointer;" class="ax_形状" >
             ...
             <div id="div_table" style="  position: absolute; top: 45px;left: 5px;">
             	...
             	<table style="border-spacing:8px 15px; text-align: center;font-size: 18px;font-family: 'Arial Normal', 'Arial'; font-weight: 400; font-style: normal; color: #333333;">
             		<tr style="padding-bottom: 30px;">
             			<td width="81px;" style="font-size: 22px;">SN</td>
             			<td width="220px;"><input id="sn" name="In.monitor.sn" style="width: 220px;height: 29px;text-align: center;"/></td>
             		</tr>
             		<tr>
             			<td width="90px;" style="font-family: 'Arial Normal', 'Arial'; font-weight: 400; font-style: normal; color: #333333;">设备名称</td>
             			<td width="220px;"><input id="monitorname" name="In.monitor.name" style="width: 220px;height: 29px;text-align: center;"/></td>
             		</tr>
             		<tr>
             			<td width="90px;" style="font-family: 'Arial Normal', 'Arial'; font-weight: 400; font-style: normal; color: #333333;">幼儿园名字</td>
             			<td width="220px;"><!-- <input style="width: 220px;height: 29px;text-align: center;"/> -->
             				<select id="kinId" style="width: 220px;height: 29px;text-align: center;" name="In.kindergarten.id">
             		...
             		<tr>
             			...
             			<td width="220px;">
             				<select id="areaId" style="width: 220px;height: 29px;text-align: center;" name="In.area.id">
             		...
             		<tr>
             			...
             			<td width="220px;">
             				<select id="careaId" style="width: 220px;height: 29px;text-align: center;" name="In.carea.id">
             		...
             		<tr>
             			<td width="90px;" style="font-family: 'Arial Normal', 'Arial'; font-weight: 400; font-style: normal; color: #333333;">摄像头观看开始时间</td>
             			<td width="220px;"><input id="begintime" name="In.monitor.beginWatchTime" style="width: 220px;height: 29px;text-align: center;"/></td>
             		</tr>
             		<tr>
             			<td width="90px;" style="font-family: 'Arial Normal', 'Arial'; font-weight: 400; font-style: normal; color: #333333;">摄像头观看结束时间</td>
             			<td width="220px;"><input id="endtime" name="In.monitor.endWatchTime" style="width: 220px;height: 29px;text-align: center;"/></td>
             		</tr>
             	</table>
             	</form>
             </div>
                  ...
                  <div style="width: 530px;position: absolute;top:52px; margin-left: 5px; ">
                  	<table class="table" width="530px;">
			         	<tr height="28px;">
			         		...
			         		<td width="75px;" nowrap="nowrap"  align="center">设备名称</td>
			         		<td width="75px;" nowrap="nowrap" align="center">序列号</td>
			         		<!-- <td width="75px;" nowrap="nowrap" align="center">最后更新时间</td>
			         		<td width="75px;" nowrap="nowrap" align="center">状态</td> -->
			         		<td width="75px;" nowrap="nowrap" align="center">摄像头观看时间段</td>
			         		<td width="75px;" nowrap="nowrap" align="center">幼儿园</td>
			         		<td width="75px;" nowrap="nowrap" align="center">班级</td>
			         	</tr>
			         	
			         	<c:forEach items="${viewMonitors }" var="mon">
			         	<tr height="28px;">
			         		<td width="15px"><input type="checkbox" class="check_id" value="${mon.monitorId }" /></td>
			         		<td width="75px;" nowrap="nowrap" align="center">${mon.monitorName }</td>
			         		<td width="75px;" nowrap="nowrap" align="center">${mon.sn }</td>
			         		<!-- <td width="75px;" nowrap="nowrap" align="center"></td>
			         		<td width="75px;" nowrap="nowrap" align="center"></td> -->
			         		<td width="75px;" nowrap="nowrap" align="center">${mon.timeQuantum }</td>
			         		<td width="75px;" nowrap="nowrap" align="center">${mon.kindergartenName }</td>
			         		<td width="75px;" nowrap="nowrap" align="center">${mon.areaName }</td>
		         		</tr>
			         	</c:forEach>
			         </table>
